...
export function ContactSection() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!form.consent) {
      setError("Please consent to communications to continue.");
      return;
    }
    setLoading(true);
    setError("");
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-start">
          ...
          >
            <motion.div variants={fadeUp}>
              <h2 className="text-4xl md:text-5xl font-display font-bold text-foreground leading-tight mb-5">
                Start a free trial of the leading SaaS & AI security platform.
              </h2>
            ...
            <motion.div variants={fadeUp} className="space-y-5">
              {[
                "See SaaS security done right, at no cost",
            ...
            <motion.div variants={fadeUp} className="grid grid-cols-3 gap-6 pt-4">
              {[
                ...
                <div key={label} className="bg-white/60 rounded-2xl p-4 border border-border/40">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      placeholder="Jane"
                      required
                      className="h-11 bg-secondary/20 border-transparent focus:bg-white focus:border-primary/30"
                      data-testid="input-trial-firstname"
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      required
                      className="h-11 bg-secondary/20 border-transparent focus:bg-white focus:border-primary/30"
                      data-testid="input-trial-lastname"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    value={form.jobTitle}
                    onChange={handleChange}
                    placeholder="CTO / Security Lead / IT Director"
                    required
                    className="h-11 bg-secondary/20 border-transparent focus:bg-white focus:border-primary/30"
                    data-testid="input-trial-jobtitle"
                  />
                </div>
                ...
                <div className="flex items-start gap-3 pt-1">
                  <input
                    ...
                    data-testid="input-trial-consent"
                  />
                ...
                <Button
                  type="submit"
                  disabled={loading}
                  className="w-full h-12 rounded-xl text-sm font-semibold bg-primary hover:bg-accent text-white shadow-md shadow-primary/20 transition-all duration-300"
